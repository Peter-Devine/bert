...
class FriendsProcessor(DataProcessor):
  ...
  def _create_examples(self, lines, set_type):
    ...
    for (i, line) in enumerate(lines):
      id_header_index = 0
      dialogue_header_index = 4
      annotation_header_index = 1
      emotion_header_index = 2
      speaker_header_index = 3
      convo_id_header_index = 5
      turn_id_header_index = 6
      # We take out our header in each dataset
      if i == 0:
        id_header_index = line.index("")
...
class FriendsContextProcessor(DataProcessor):
  """Processor for the custom emotion data set."""
...
class SemEval2019Task3Processor(DataProcessor):
  """Processor for the custom emotion data set."""
...
class SemEval2019Task3ContextProcessor(DataProcessor):
  """Processor for the custom emotion data set."""
...
class EMOTERAProcessor(DataProcessor):
  """Processor for the custom emotion data set."""
  ...
  def get_labels(self):
    """See base class."""
    return ['Anger', 'Anticipation', 'Disgust', 'Fear', 'Joy', 'Other', 'Sadness', 'Surprise', 'Trust']
...
class SSECAngerProcessor(DataProcessor):
  ...
  def _create_examples(self, lines, set_type):
    ...
    for (i, line) in enumerate(lines):
      id_header_index = 0
      dialogue_header_index = 9
      emotion_header_index = 10
      # We take out our header in each dataset
      if i == 0:
        id_header_index = line.index("")
        dialogue_header_index = line.index("Text")
        emotion_header_index = line.index("anger_present")
        continue
      guid = "%s-%s" % (set_type, i)
      if set_type == "test":
        text_a = tokenization.convert_to_unicode(line[dialogue_header_index])
...
class SSECAnticipationProcessor(DataProcessor):
  ...
  def _create_examples(self, lines, set_type):
    ...
    for (i, line) in enumerate(lines):
      id_header_index = 0
      dialogue_header_index = 9
      emotion_header_index = 11
      # We take out our header in each dataset
      if i == 0:
        id_header_index = line.index("")
        dialogue_header_index = line.index("Text")
        emotion_header_index = line.index("anticipation_present")
        continue
      guid = "%s-%s" % (set_type, i)
      if set_type == "test":
        text_a = tokenization.convert_to_unicode(line[dialogue_header_index])
  ...
  def _create_examples(self, lines, set_type):
    ...
    for (i, line) in enumerate(lines):
      ...
      if i == 0:
        id_header_index = line.index("")
        dialogue_header_index = line.index("Text")
        emotion_header_index = line.index("disgust_present")
        continue
      guid = "%s-%s" % (set_type, i)
      if set_type == "test":
        text_a = tokenization.convert_to_unicode(line[dialogue_header_index])
...
class SSECFearProcessor(DataProcessor):
  ...
  def _create_examples(self, lines, set_type):
    ...
    for (i, line) in enumerate(lines):
      id_header_index = 0
      dialogue_header_index = 9
      emotion_header_index = 13
      # We take out our header in each dataset
      if i == 0:
        id_header_index = line.index("")
        dialogue_header_index = line.index("Text")
        emotion_header_index = line.index("fear_present")
        continue
      guid = "%s-%s" % (set_type, i)
      if set_type == "test":
        text_a = tokenization.convert_to_unicode(line[dialogue_header_index])
...
class SSECJoyProcessor(DataProcessor):
  ...
  def _create_examples(self, lines, set_type):
    ...
    for (i, line) in enumerate(lines):
      id_header_index = 0
      dialogue_header_index = 9
      emotion_header_index = 14
      # We take out our header in each dataset
      if i == 0:
        id_header_index = line.index("")
        dialogue_header_index = line.index("Text")
        emotion_header_index = line.index("joy_present")
        continue
      guid = "%s-%s" % (set_type, i)
      if set_type == "test":
        text_a = tokenization.convert_to_unicode(line[dialogue_header_index])
...
class SSECSadnessProcessor(DataProcessor):
  ...
  def _create_examples(self, lines, set_type):
    ...
    for (i, line) in enumerate(lines):
      id_header_index = 0
      dialogue_header_index = 9
      emotion_header_index = 15
      # We take out our header in each dataset
      if i == 0:
        id_header_index = line.index("")
        dialogue_header_index = line.index("Text")
        emotion_header_index = line.index("sadness_present")
        continue
      guid = "%s-%s" % (set_type, i)
      if set_type == "test":
        text_a = tokenization.convert_to_unicode(line[dialogue_header_index])
...
class SSECSurpriseProcessor(DataProcessor):
  ...
  def _create_examples(self, lines, set_type):
    ...
    for (i, line) in enumerate(lines):
      id_header_index = 0
      dialogue_header_index = 9
      emotion_header_index = 16
      # We take out our header in each dataset
      if i == 0:
        id_header_index = line.index("")
        dialogue_header_index = line.index("Text")
        emotion_header_index = line.index("surprise_present")
        continue
      guid = "%s-%s" % (set_type, i)
      if set_type == "test":
        text_a = tokenization.convert_to_unicode(line[dialogue_header_index])
...
class SSECTrustProcessor(DataProcessor):
  ...
  def _create_examples(self, lines, set_type):
    ...
    for (i, line) in enumerate(lines):
      id_header_index = 0
      dialogue_header_index = 9
      emotion_header_index = 17
      # We take out our header in each dataset
      if i == 0:
        id_header_index = line.index("")
        dialogue_header_index = line.index("Text")
        emotion_header_index = line.index("trust_present")
        continue
      guid = "%s-%s" % (set_type, i)
      if set_type == "test":
        text_a = tokenization.convert_to_unicode(line[dialogue_header_index])
...
class EmotionStimulusProcessor(DataProcessor):
  ...
  def get_labels(self):
    """See base class."""
    return ['happy', 'sad', 'surprise', 'disgust', 'anger', 'fear', 'shame']
